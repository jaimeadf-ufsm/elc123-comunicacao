# Convert the 8b6t table text into a JavaScript object where bit sequences are keys
# and level sequences are values
...
# Split and reformat into dictionary
entries = raw_table.split()
bit_to_level = {format(int(entries[i], 16), '08b'): entries[i + 1] for i in range(0, len(entries), 2)}

# Convert to JavaScript format
js_array = "const table8b6t = {\n" + ",\n".join([f'  "{k}": "{v}"' for k, v in bit_to_level.items()]) + "\n};"
